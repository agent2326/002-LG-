  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <Reveal enabled={enableAnimations} animation={animationType} className="text-center mb-16">
          <h2 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {data.items.map((item, idx) => (
            <Reveal key={idx} enabled={enableAnimations} animation={animationType} delay={idx * 100}>
